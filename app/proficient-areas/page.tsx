...
const ProficientAreas = () => {
  ...
  return (
    <div className="w-full bg-[#090707] flex flex-col items-center py-10 px-4 sm:px-6 lg:px-8">
      {/* Section Titles */}
      <div className="w-full max-w-[1200px] pl-[60px] md:pl-[80px] flex flex-col md:flex-row justify-between items-center md:items-start px-4 space-y-6 md:space-y-0">
        {/* Left Title */}
        <div className="flex flex-col items-start space-y-2">
          <h2
            className={`${figtree.className} italic text-[40px] sm:text-[60px] md:text-[80px] lg:text-[100px] xl:text-[120px] leading-[1] text-white uppercase`}
          >
            ProficienT
          </h2>
          <div className="flex items-center space-x-4">
            ...
            <div className="w-[50px] sm:w-[70px] md:w-[100px] border-t border-white" />
          </div>
        </div>
        ...
        <div className="flex flex-col items-end space-y-2">
          <h2
            className={`text-white font-extrabold text-[40px] sm:text-[60px] md:text-[80px] lg:text-[100px] xl:text-[120px] leading-[1] uppercase ${figtree.className}`}
          >
            AREAs
          </h2>
          <div className="flex items-center space-x-4">
      ...
      {/* Cards Grid */}
      <div className="w-full max-w-[1200px] pl-[60px] md:pl-[80px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6 px-4">
...
const Card = ({ iconSrc, title, description }: ProficientCard) => (
  <div className="relative w-full h-[300px] flex flex-col justify-start items-start p-6 bg-[rgba(174,174,174,0.1)] backdrop-blur-[15px] rounded-[20px] border border-[#2C2C2C]">
    <Image
      src={iconSrc}
      alt={title}
      width={64}
    ...
    />
    <h3 className="font-poppins font-bold text-[20px] md:text-[24px] text-white leading-[1.2]">
      {title}
    </h3>
    <p className="font-poppins font-normal text-[14px] md:text-[16px] text-[#A4A4A4] leading-[1.5] mt-2">
      {description}
    </p>
  </div>
);
