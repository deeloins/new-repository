          ...
          >
            <div className={styles.aboutMeContent}>
              ...
              <p className={styles.aboutMeText}>
                ...
                success in them, neither provided the meaningful impact I
                sought. Driven by a strong desire to create meaningful impact, I
                spent considerable time searching for the right fit. The turning
                point came with my mentor, Alex Oyebade, who suggested I
                investigate UX writing. This sparked a profound interest,
                leading me to discover the powerful potential of product design
                in solving complex user and business problems.
              </p>
